...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (signUpError) {
      ...
      // If disabled, the user is logged in immediately
      if (data?.user) {
        setTimeout(() => {
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          {/* Success Message */}
          {success && (
            <div className="rounded-md bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 p-3 text-sm text-emerald-600 dark:text-emerald-400">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 pl-10 pr-3 py-2 text-sm text-slate-900 dark:text-white placeholder-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
        ...
        <div className="mt-4 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4">
          <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-2">
            Demo Credentials (after setting up Supabase):
          </p>
          <p className="text-xs text-slate-400">
            <strong>Admin:</strong> admin@boutiqueos.com / password123
          </p>
          <p className="text-xs text-slate-400">
            <strong>Cashier:</strong> cashier@boutiqueos.com / password123
          </p>
        </div>
      </div>
    </div>
